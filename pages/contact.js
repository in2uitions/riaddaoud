                    ...
                    <div className="row  ">
                        ...
                        <form onSubmit={this.handleLogin} className=" col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12"  >
                            ...
                            <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 p-2">
                                <div className="form-row">
                                    <div className="col">
                                        <input type="tel" title="Format: ex: +86 800 555 1234 ( Country Code,Area Code, Exchange,Subscriber Number)" id="phone" inputmode="numeric" minlength="8" pattern="^\s*(?:\+?(\d{1,3}))?[-. (]*(\d{3})[-. )]*(\d{3})[-. ]*(\d{4})(?: *x(\d+))?\s*$" name="text" onChange={this.handlePhoneChange} className={(this.props.i18n.language=="ar")?"form-control DroidKufi placeholder  animation js--fadeInRight  bordernone textalignright":"form-control  gill placeholder  animation js--fadeInRight lightitalic bordernone "} placeholder={this.props.t("phonenbplaceholder")} required maxlength="200"/>
                                    </div>
                                    <div className="col">
